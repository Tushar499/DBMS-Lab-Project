...
<body>
  ...
  <div class="searchbarWrapper">
    <span onclick="openNav()"><img src="https://cdn4.iconfinder.com/data/icons/wirecons-free-vector-icons/32/menu-alt-512.png" width="40px" style="padding-top: 0px; padding-left: 40px;"></span>
        <form class="searchbarWrapper" action="s_searchpost.php" method="post">
          <input id="searchbar" name = "searchbox" type="text" style="border: 1px solid #2974e5d7;width:400px">
  ...
  <div id="main">
    <section style="padding-left:400px;padding-right:400px">
      <div class="container">
        <h2 class="studentHeading" style="text-align:center; color: #2974e5d7;" >Recent Jobs</h2>
        <?php
            require_once "database.php";
            $sql = "SELECT * FROM job ORDER BY date ASC,time DESC";
