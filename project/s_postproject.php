...
<body>
  ...
  <div id="main">
    <section style="padding-left:300px;padding-right:300px">
      <form style="padding-left:400px;padding-bottom:20px" action="s_projectsearch.php" method="post">
        <input style="width:400px;height:30px" type="text" name="psearch" value="">
        <input class="searchbtn" type="submit" name="srch" value="SEARCH">
      </form>
      <div class="container">
        <h2 style="text-align:center; color: #2974e5d7;" >Recent Posted Thesis/Final Projects</h2>
        <?php
            require_once "database.php";
            $sql = "SELECT * FROM thesis WHERE p_date != '' ORDER BY p_date DESC,p_time DESC";
