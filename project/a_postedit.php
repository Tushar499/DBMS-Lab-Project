...
<body>
  ...
  <?php
      ...
      if(isset($_POST['edit'])){
        $_SESSION['a_postid'] = $_POST['id'];
      }
      $id = $_SESSION['a_postid'];
      echo $id;
   ?>
  <div id="main">
    <section>
      <a style="float:right" href="a_postjob.php">
    ...
    <div style="padding-left:300px">
      <form action="a_postedit.php" class="sturecapply-form facultyapply-form" method="post" enctype="multipart/form-data">
